		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "SGMR Mobile",
									"targetURL": "#compontualsgmr-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"compontualsgmr-display": {
								"semanticObject": "compontualsgmr",
								"action": "display",
								"description": "Sistema de Gestão Material Rodante",
								"title": "SGMR Mobile",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.pontual.sgmr",
									"url": sap.ui.require.toUrl("com/pontual/sgmr")
								}
							}
						}
					}
